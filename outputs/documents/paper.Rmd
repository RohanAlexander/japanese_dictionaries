...
For the purpose of this study, one page from the letter a in the Japanese dictionary was taken to assess the selected OCR tools. The image contains 3293 characters. Words in English were counted as one character for this analysis. MOreover, the sample text was divided into four images called **sections** as it is illustrated in figure XX. These new images were assessed across all OCR tools.

![image](https://raw.githubusercontent.com/RohanAlexander/japanese_dictionaries/master/outputs/documents/sections.png)
**Figure XX**
...
![image](https://raw.githubusercontent.com/RohanAlexander/japanese_dictionaries/master/inputs/cropped%20pages/00-sample_pages_3_sec_1.png)
**Figure XX Section 1**

![image](https://raw.githubusercontent.com/RohanAlexander/japanese_dictionaries/master/inputs/cropped%20pages/00-sample_pages_3_sec_2.png)
**Figure XX Section 2**

![image](https://raw.githubusercontent.com/RohanAlexander/japanese_dictionaries/master/inputs/cropped%20pages/00-sample_pages_3_sec_3.png)
**Figure XX Section 3**

![image](https://raw.githubusercontent.com/RohanAlexander/japanese_dictionaries/master/inputs/cropped%20pages/00-sample_pages_3_sec_4.png)
**Figure XX Section 4**
...
![image](E:/Users/Usuario/Documents/GitHub_Website/website/japanese_dictionaries/outputs/documents/azure-images/self-detection.png)
 **Figure xx**
...
![image](E:/Users/Usuario/Documents/GitHub_Website/website/japanese_dictionaries/outputs/documents/azure-images/japanese-parameter.png)
 **Figure 7**
...
Unlike Azure Cognitive Services, which returns each recognized character individually, Google Vision groups characters in some cases. This situation adds some degree of complexity when processin the response from the API. **[Not sure if it is a disadvantage in real life]**
...
Some lines were completely ignored by Pyteseract, even thought it was clear enough to be recognized by the tool.
...
The Kindai-OCR code was developed in Python and released as an open source code in August 2020 on Github..The Github folder contains all the necessary code and instructions to assess the OCR tool. **[not sure if it is necessary to mention the modification in the file test.py, in order to run the model using GPUs.]**

After running the Kindai-OCR for our samples, the system generated two main outputs. They are explained as follows:

### File result.xml

This file is presented in an Extensible Markup Language (XML) format containing a tree with the identified lines, as well as the corresponding characters. An example of the is shown as follows:
...
![image](E:/Users/Usuario/Documents/GitHub_Website/website/japanese_dictionaries/outputs/documents/kindai-images/xml-processed.png)   
 **Figure XX**
...
![image](E:/Users/Usuario/Documents/GitHub_Website/website/japanese_dictionaries/outputs/documents/kindai-images/kindai-section1.jpg)
**Figure XX**
...
At the time of this assessment, the use of GPUs is required which is a limitation to take into account. For this study, we used Colab from Google, which offers this capability. 
