...
In this section we introduce the OCR options that we consider, they essential features and cost.

There are seven OCR options evaluated in this study (Table \@ref(tab:tableofoptions)).
