...
In this section we introduce the OCR options that we consider, their essential features, and cost. There are **eight** **[UPDATE]** OCR options evaluated in this study (Table \@ref(tab:tableofoptions)).
...
A common reason for wanting to 
**TBD.**
